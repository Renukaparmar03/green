...
const foodLandingSettingsSchema = new mongoose.Schema(
    {
        ...
        appLinks: {
            playStore: { type: String, default: 'https://play.google.com/store/apps/details?id=com.indian.Carvioo.user' },
        ...
        copyrightText: {
            type: String,
            default: '© 2026 Carvioo Food Delivery™ Ltd. All rights reserved.'
        },
        heroSlides: {
            type: Array,
            default: [
