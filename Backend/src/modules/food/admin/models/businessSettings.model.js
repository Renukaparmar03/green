...
const businessSettingsSchema = new mongoose.Schema(
    {
        companyName: { type: String, required: true, default: 'Carvioo' },
        email: { type: String, required: true, default: 'admin@carvioo.com' },
        phone: {
        ...
        supportEmail: { type: String, default: 'support@carvioo.com' },
        ...
        uploadDestination: { type: String, enum: ['default', 'vps', 'cloudinary'], default: 'default' }
    },
    { timestamps: true }
);
