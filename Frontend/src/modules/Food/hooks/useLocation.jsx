        ...
        try {
          ...
          const nomRes = await fetch(
            `https://nominatim.openstreetmap.org/reverse?format=jsonv2&lat=${latitude}&lon=${longitude}&addressdetails=1`,
            {
              ...
              headers: { 'Accept-Language': 'en', 'User-Agent': 'Carvioo Food Delivery-App' }
            }
          )
...
export function useLocationEngine() {
  ...
  const reverseGeocodeWithOLAMaps = async (latitude, longitude) => {
    try {
      ...
      // PRIORITY 1: Extract area from formatted_address FIRST (most reliable for Carvioo Food addresses)
      // Carvioo Food address format: "Area, City, State" e.g., "New Palasia, Indore, Madhya Pradesh"
