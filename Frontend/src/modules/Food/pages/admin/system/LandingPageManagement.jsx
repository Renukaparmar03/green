...
export default function LandingPageManagement() {
  ...
  const [settings, setSettings] = useState({
    ...
    appLinks: { playStore: 'https://play.google.com/store/apps/details?id=com.indian.Carvioo.user', appStore: '' },
    ...
    copyrightText: '© 2026 Carvioo Food Delivery™ Ltd. All rights reserved.',
    heroSlides: []
  })
    ...
    try {
      ...
      if (response.data.success) {
        ...
        setSettings({
          ...
          appLinks: nextSettings.appLinks || { playStore: 'https://play.google.com/store/apps/details?id=com.indian.Carvioo.user', appStore: '' },
          ...
          copyrightText: nextSettings.copyrightText || '© 2026 Carvioo Food Delivery™ Ltd. All rights reserved.',
              ...
              <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {[
                    ...
                    const dCarvioom = exploreMore.find(i => i.label?.toLowerCase() === item.label.toLowerCase())
                      ...
                      <div key={item.id} className="border border-slate-200 rounded-lg p-4 flex flex-col items-center relative">
                        ...
                        <div className="w-full mt-auto">
                          ...
                          >
                            ...
                            {dCarvioom ? 'Change Icon' : 'Upload Icon'}
                          </label>
                        </div>
                      </div>
                    )
          ...
          <div className="space-y-6">
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
              ...
              <div className="mb-6">
                ...
                <Input value={settings.copyrightText || ''} onChange={(e) => setSettings({ ...settings, copyrightText: e.target.value })} placeholder="© 2026 Carvioo Food Delivery™ Ltd." />
              </div>
