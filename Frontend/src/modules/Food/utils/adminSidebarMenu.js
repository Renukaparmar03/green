  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        label: "Categories",
        icon: "FolderTree",
        suCarviooms: [{ label: "Category", path: "/admin/food/categories" }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { type: "link", label: "Tax Report", path: "/admin/food/tax-report", icon: "Receipt" },
      {
        ...
        icon: "FileText",
        suCarviooms: [{ label: "Restaurant Report", path: "/admin/food/restaurant-report" }],
      },
      {
        type: "expandable",
        label: "Customer Report",
        icon: "FileText",
        suCarviooms: [{ label: "Feedback Experience", path: "/admin/food/customer-report/feedback-experience" }],
      },
    ],
  },
  {
